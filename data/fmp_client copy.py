...
# Increase connection pool to match ASYNC_FETCH_WORKERS (default 40)
# Default pool size is 10 — causes "Connection pool is full" warnings with async fetching
...
_SECTOR_CACHE: Dict[str, str] = {}   # {symbol: sector}
